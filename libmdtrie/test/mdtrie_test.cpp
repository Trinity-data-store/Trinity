...
bool test_random_data(n_leaves_t n_points, level_t max_depth,
...
bool test_nonexistent_data(n_leaves_t n_points, level_t max_depth,
...
bool test_contiguous_data(n_leaves_t n_points, level_t max_depth,
                          level_t trie_depth, preorder_t max_tree_node) {
