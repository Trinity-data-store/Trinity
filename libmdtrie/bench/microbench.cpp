...
void github_bench(void) {
  ...
  bench.insert(GITHUB_DATA_ADDR, "github_insert_micro" + identification_string,
...
void nyc_bench(void) {
  ...
  bench.insert(NYC_DATA_ADDR, "nyc_insert_micro" + identification_string,
  ...
  bench.range_search(NYC_QUERY_ADDR, "nyc_query_micro" + identification_string,
...
void tpch_bench(void) {
  ...
  bench.insert(TPCH_DATA_ADDR, "tpch_insert_micro" + identification_string,
...
void sensitivity_num_dimensions_9(void) {
  ...
  bench.range_search_random(
      "tpch_query_dimensions_sensitivity" + identification_string + "_" + "9",
...
void sensitivity_num_dimensions_8(void) {
  ...
  bench.range_search_random(
      "tpch_query_dimensions_sensitivity" + identification_string + "_" + "8",
...
void sensitivity_num_dimensions_7(void) {
  ...
  bench.range_search_random(
      "tpch_query_dimensions_sensitivity" + identification_string + "_" + "7",
...
void sensitivity_num_dimensions_6(void) {
  ...
  bench.range_search_random(
      "tpch_query_dimensions_sensitivity" + identification_string + "_" + "6",
...
void sensitivity_num_dimensions_5(void) {
  ...
  bench.range_search_random(
      "tpch_query_dimensions_sensitivity" + identification_string + "_" + "5",
...
void sensitivity_num_dimensions_4(void) {
  ...
  bench.range_search_random(
      "tpch_query_dimensions_sensitivity" + identification_string + "_" + "4",
...
void sensitivity_selectivity(void) {
  ...
  bench.insert(TPCH_DATA_ADDR,
               ...
               total_points_count, parse_line_tpch);
  bench.range_search_random(
      "tpch_query_selectivity_sensitivity" + identification_string,
