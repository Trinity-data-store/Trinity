...
void github_bench(void) {
    ...
    bench.range_search(GITHUB_QUERY_ADDR, "github_query_micro" + identification_string, get_query_github<GITHUB_DIMENSION>);
}
...
void nyc_bench(void) {
    ...
    bench.range_search(NYC_QUERY_ADDR, "nyc_query_micro" + identification_string, get_query_nyc<NYC_DIMENSION>);
}
...
void tpch_bench(void) {
    ...
    bench.range_search(TPCH_QUERY_ADDR, "tpch_query_micro" + identification_string, get_query_tpch<TPCH_DIMENSION>);
}
...
void sensitivity_num_dimensions_9(void) {
    ...
    bench.range_search_random("tpch_query_dimensions_sensitivity" + identification_string + "_" + "9", get_random_query_tpch<9>, micro_tpch_size * selectivity_upper, micro_tpch_size * selectivity_lower);
}
...
void sensitivity_num_dimensions_8(void) {
    ...
    bench.range_search_random("tpch_query_dimensions_sensitivity" + identification_string + "_" + "8", get_random_query_tpch<8>, micro_tpch_size * selectivity_upper, micro_tpch_size * selectivity_lower);
}
...
void sensitivity_num_dimensions_7(void) {
    ...
    bench.range_search_random("tpch_query_dimensions_sensitivity" + identification_string + "_" + "7", get_random_query_tpch<7>, micro_tpch_size * selectivity_upper, micro_tpch_size * selectivity_lower);
}
...
void sensitivity_num_dimensions_6(void) {
    ...
    bench.range_search_random("tpch_query_dimensions_sensitivity" + identification_string + "_" + "6", get_random_query_tpch<6>, micro_tpch_size * selectivity_upper, micro_tpch_size * selectivity_lower);
}
...
void sensitivity_num_dimensions_5(void) {
    ...
    bench.range_search_random("tpch_query_dimensions_sensitivity" + identification_string + "_" + "5", get_random_query_tpch<5>, micro_tpch_size * selectivity_upper, micro_tpch_size * selectivity_lower);
}
...
void sensitivity_num_dimensions_4(void) {
    ...
    bench.range_search_random("tpch_query_dimensions_sensitivity" + identification_string + "_" + "4", get_random_query_tpch<4>, micro_tpch_size * selectivity_upper, micro_tpch_size * selectivity_lower);
}
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "benchmark: " << argvalue << ", optimization: " << optimization << ", dimensions: " << sensitivity_dimensions << std::endl;
    if (argvalue == "tpch") 
        tpch_bench();
        ...
        switch (sensitivity_dimensions) {
            ...
            case 4:
                ...
                break;
            default:
                std::cout << "wrong dimensions: " << sensitivity_dimensions << std::endl;
                abort ();
        }
    }
