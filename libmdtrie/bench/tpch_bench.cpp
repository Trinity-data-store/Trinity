...
void run_bench(){
    ...
    flush_vector_to_file(insertion_latency_vect, results_folder_addr + "tpch_insert_micro" + identification_string);
    infile.close();
    ...
    flush_vector_to_file(lookup_latency_vect, results_folder_addr + "tpch_lookup_micro" + identification_string);
    ...
    */
    ...
    std::string outfile_address = results_folder_addr + "tpch_query_micro" + identification_string;
