...
for i in $(seq 3 $((2 + $num_clients - 1)))
do
    ...
    do
        ...
        sudo scp -i /proj/trinity-PG0/Trinity/scripts/key -o StrictHostKeyChecking=no -r $local_dir/$repo/x0$(($i - 2)) Ziming@10.10.1.$i:$local_dir/$repo &
    done
done
