...
total_vect = []
num_data_nodes = 5
skip_points = int(10000000 / 10) # 10M # Need to run aerospike_insert first!!
...
if int(sys.argv[1]) == 0:
    with open('/proj/trinity-PG0/Trinity/baselines/timescaleDB/python/github_insert_lookup_throughput.txt', 'a') as f:
