...
total_vect = []
num_data_nodes = 5
total_skip = int(40000000)
total_points = int(40000000 + 5000000) # 2M # 5 min
...
if int(sys.argv[1]) == 0:
    with open('/proj/trinity-PG0/Trinity/baselines/timescaleDB/python/github_insert_throughput.txt', 'a') as f:
