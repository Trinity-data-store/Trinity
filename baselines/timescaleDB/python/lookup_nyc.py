...
def lookup_each_worker(worker_idx, total_workers):
    ...
    with open(file_path) as f:
        for line in f:
            ...
            cursor_list[hash_i % 5].execute("SELECT * FROM nyc_taxi WHERE pkey = {}".format(primary_key))
...
if int(sys.argv[1]) == 0:
    with open('/proj/trinity-PG0/Trinity/baselines/timescaleDB/python/nyc_lookup_throughput.txt', 'a') as f:
