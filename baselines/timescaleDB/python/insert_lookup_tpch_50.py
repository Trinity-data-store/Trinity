    ...
    with open(file_path) as f:
        for line in f:
            ...
            if is_insert or line_count < skip_points:
                ...
                cursor_lookup_list[hash(primary_key) % 5].execute("SELECT * FROM tpch_macro WHERE ID = {}".format(primary_key))
...
if int(sys.argv[1]) == 0:
    with open('/proj/trinity-PG0/Trinity/baselines/timescaleDB/python/tpch_insert_lookup_throughput_50.txt', 'a') as f:
