...
flush_list_to_file(insert_latency_vect, "/proj/trinity-PG0/Trinity/results/latency_cdf/clickhouse_github_insert")
flush_list_to_file(lookup_latency_vect, "/proj/trinity-PG0/Trinity/results/latency_cdf/clickhouse_github_lookup")