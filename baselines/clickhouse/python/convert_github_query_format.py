...
datapath = "/proj/trinity-PG0/Trinity/results/github_clickhouse"
outfile = open("/proj/trinity-PG0/Trinity/queries/github/github_query_new_converted", "w")  # write mode
