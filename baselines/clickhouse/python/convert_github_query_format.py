...
datapath = "/proj/trinity-PG0/Trinity/queries/github/github_query_new"
outfile = open("/proj/trinity-PG0/Trinity/queries/github/github_query_new_timestamps_converted", "w")  # write mode
...
if __name__ == "__main__": 
    ...
    with open("{}".format(datapath)) as ifile:
        ...
        for line in ifile:
            ...
            if m:
                out_line = "8,{},{},9,{},{}".format(m.group("start_date_start"), m.group("start_date_end"), m.group("end_date_start"), m.group("end_date_end"))
                outfile.write(out_line + "\n")
                continue
