...
query2 = "SELECT * FROM tpch_macro WHERE ORDERDATE <= 19935761 AND SHIPDATE >= 19939422;"
query1 = "SELECT * FROM tpch_macro WHERE ORDERDATE <= 19972160 AND SHIPDATE >= 19979503;"
start = time.time()
