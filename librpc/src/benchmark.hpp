...
class TrinityBench {
    public:
        ...
        TrinityBench(int shard_num, int client_num, int client_server_num, std::vector<std::string> server_ips, int dataset_idx, int num_dimensions) {
            ...
            switch(dataset_idx) {
                ...
                case(GITHUB):
                    ...
                    dataset_addr_ = GITHUB_DATA_ADDR;
        ...
        void load_dataset(std::vector<int32_t> (* parse_line)(std::string)) {
            ...
            std::string line;
            for (uint32_t i = 0; i < dataset_size_; i++){
        ...
        uint32_t insert_each_client(int client_index, int points_to_insert) {
        ...
        uint32_t lookup_each_client(int client_index, int points_to_lookup) {
        ...
        uint32_t mixed_query_benchmark(int num_lookup, int num_insert, int num_search) {
