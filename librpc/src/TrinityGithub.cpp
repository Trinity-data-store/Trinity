...
int main(int argc, char *argv[]){
    ...
    std::ofstream outfile(results_folder_addr + "macrobenchmark/github_macro_Trinity_" + std::to_string(dataset_part), ios_base::app);
    ...
    if (benchmark_str == "insert") {
        ...
        outfile << "size: " << bench.get_size() << "," << GITHUB_SIZE << std::endl;
    }
