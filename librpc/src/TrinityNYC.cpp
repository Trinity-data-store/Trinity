...
int main(int argc, char *argv[]){
    ...
    std::ofstream outfile(results_folder_addr + "macrobenchmark/nyc_macro_Trinity_" + std::to_string(dataset_part), ios_base::app);

    std::vector<std::string> server_ips = {"10.10.1.12", "10.10.1.13", "10.10.1.14", "10.10.1.15", "10.10.1.16"};
    TrinityBench bench(shard_num, client_num, client_server_number, server_ips, NYC, dataset_part);
