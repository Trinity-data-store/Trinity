...
class MDTrieCloneFactory : virtual public MDTrieShardIfFactory {
 public:
  ...
  MDTrieIf* getHandler(const ::apache::thrift::TConnectionInfo& connInfo) override
  {
...
int main() {
  TThreadedServer server(
    std::make_shared<MDTrieProcessorFactory>(std::make_shared<MDTrieCloneFactory>()),
