...
class MDTrieShardIf {
 public:
  ...
  virtual int32_t insert_for_latency(const std::vector<int32_t> & point, const int32_t primary_key) = 0;
...
typedef struct _MDTrieShard_insert_for_latency_args__isset {
  _MDTrieShard_insert_for_latency_args__isset() : point(false), primary_key(false) {}
  bool point :1;
  bool primary_key :1;
...
class MDTrieShard_insert_for_latency_args {
 public:
  ...
  MDTrieShard_insert_for_latency_args(const MDTrieShard_insert_for_latency_args&);
  MDTrieShard_insert_for_latency_args& operator=(const MDTrieShard_insert_for_latency_args&);
  MDTrieShard_insert_for_latency_args() : primary_key(0) {
  }
...
typedef struct _MDTrieShard_insert_for_latency_result__isset {
  _MDTrieShard_insert_for_latency_result__isset() : success(false) {}
  bool success :1;
...
class MDTrieShard_insert_for_latency_result {
 public:
  ...
  MDTrieShard_insert_for_latency_result(const MDTrieShard_insert_for_latency_result&);
  MDTrieShard_insert_for_latency_result& operator=(const MDTrieShard_insert_for_latency_result&);
  MDTrieShard_insert_for_latency_result() : success(0) {
  }
...
typedef struct _MDTrieShard_insert_for_latency_presult__isset {
  _MDTrieShard_insert_for_latency_presult__isset() : success(false) {}
  bool success :1;
...
class MDTrieShard_primary_key_lookup_path_args {
 public:
  ...
  MDTrieShard_primary_key_lookup_path_args(const MDTrieShard_primary_key_lookup_path_args&);
  MDTrieShard_primary_key_lookup_path_args& operator=(const MDTrieShard_primary_key_lookup_path_args&);
  MDTrieShard_primary_key_lookup_path_args() : primary_key(0) {
  }
...
class MDTrieShard_primary_key_lookup_path_result {
 public:
  ...
  MDTrieShard_primary_key_lookup_path_result() {
  }
...
class MDTrieShard_primary_key_lookup_binary_args {
 public:
  ...
  MDTrieShard_primary_key_lookup_binary_args(const MDTrieShard_primary_key_lookup_binary_args&);
  MDTrieShard_primary_key_lookup_binary_args& operator=(const MDTrieShard_primary_key_lookup_binary_args&);
  MDTrieShard_primary_key_lookup_binary_args() : primary_key(0) {
  }
...
class MDTrieShard_primary_key_lookup_binary_result {
 public:
  ...
  MDTrieShard_primary_key_lookup_binary_result() : success() {
  }
...
class MDTrieShard_get_insert_latency_args {
 public:
  ...
  MDTrieShard_get_insert_latency_args(const MDTrieShard_get_insert_latency_args&);
  MDTrieShard_get_insert_latency_args& operator=(const MDTrieShard_get_insert_latency_args&);
  MDTrieShard_get_insert_latency_args() {
  }
...
class MDTrieShard_get_insert_latency_result {
 public:
  ...
  MDTrieShard_get_insert_latency_result() {
  }
...
class MDTrieShard_get_lookup_latency_args {
 public:
  ...
  MDTrieShard_get_lookup_latency_args(const MDTrieShard_get_lookup_latency_args&);
  MDTrieShard_get_lookup_latency_args& operator=(const MDTrieShard_get_lookup_latency_args&);
  MDTrieShard_get_lookup_latency_args() {
  }
...
class MDTrieShard_get_lookup_latency_result {
 public:
  ...
  MDTrieShard_get_lookup_latency_result() {
  }
...
class MDTrieShardClientT : virtual public MDTrieShardIf {
 ...
 public:
  ...
  int32_t recv_insert();
  int32_t insert_for_latency(const std::vector<int32_t> & point, const int32_t primary_key);
  void send_insert_for_latency(const std::vector<int32_t> & point, const int32_t primary_key);
...
class MDTrieShardProcessorT : public ::apache::thrift::TDispatchProcessorT<Protocol_> {
 ...
 private:
  ...
  void process_insert_for_latency(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_insert_for_latency(int32_t seqid, Protocol_* iprot, Protocol_* oprot, void* callContext);
 ...
 public:
  MDTrieShardProcessorT(::std::shared_ptr<MDTrieShardIf> iface) :
    ...
    processMap_["insert"] = ProcessFunctions(
      ...
      &MDTrieShardProcessorT::process_insert);
    processMap_["insert_for_latency"] = ProcessFunctions(
  ...
  MDTrieShardConcurrentClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  int32_t insert_for_latency(const std::vector<int32_t> & point, const int32_t primary_key);
  int32_t send_insert_for_latency(const std::vector<int32_t> & point, const int32_t primary_key);
