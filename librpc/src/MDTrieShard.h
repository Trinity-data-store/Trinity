...
public:
  ...
  MDTrieShard_ping_args() noexcept : dataset_idx(0) {}
  ...
  template <class Protocol_> uint32_t read(Protocol_ *iprot);
  template <class Protocol_> uint32_t write(Protocol_ *oprot) const;
};
...
public:
  ...
  MDTrieShard_ping_result() noexcept : success(0) {}
...
public:
  ...
  MDTrieShard_insert_args() noexcept : primary_key(0) {}
...
public:
  ...
  MDTrieShard_insert_result &
  operator=(const MDTrieShard_insert_result &) noexcept;
  MDTrieShard_insert_result() noexcept : success(0) {}
...
public:
  ...
  MDTrieShard_insert_for_latency_args &
  operator=(const MDTrieShard_insert_for_latency_args &);
  MDTrieShard_insert_for_latency_args() noexcept : primary_key(0) {}
...
public:
  ...
  MDTrieShard_insert_for_latency_result &
  operator=(const MDTrieShard_insert_for_latency_result &) noexcept;
  MDTrieShard_insert_for_latency_result() noexcept : success(0) {}
...
public:
  ...
  MDTrieShard_check_result &
  operator=(const MDTrieShard_check_result &) noexcept;
  MDTrieShard_check_result() noexcept : success(0) {}
...
typedef struct _MDTrieShard_range_search_args__isset {
  _MDTrieShard_range_search_args__isset()
      : start_range(false), end_range(false) {}
  bool start_range : 1;
  bool end_range : 1;
} _MDTrieShard_range_search_args__isset;
...
public:
  ...
  operator=(const MDTrieShard_range_search_args &);
...
public:
  ...
  operator=(const MDTrieShard_range_search_result &);
...
public:
  ...
  MDTrieShard_primary_key_lookup_args &
  operator=(const MDTrieShard_primary_key_lookup_args &) noexcept;
  MDTrieShard_primary_key_lookup_args() noexcept : primary_key(0) {}
...
public:
  ...
  MDTrieShard_primary_key_lookup_result &
  operator=(const MDTrieShard_primary_key_lookup_result &);
...
public:
  ...
  operator=(const MDTrieShard_get_size_args &) noexcept;
...
public:
  ...
  MDTrieShard_get_size_result &
  operator=(const MDTrieShard_get_size_result &) noexcept;
  MDTrieShard_get_size_result() noexcept : success(0) {}
...
protected:
  ...
  virtual bool dispatchCallTemplated(Protocol_ *iprot, Protocol_ *oprot,
                                     const std::string &fname, int32_t seqid,
                                     void *callContext);
...
private:
  ...
  struct ProcessFunctions {
    ...
    ProcessFunctions(ProcessFunction g, SpecializedProcessFunction s)
        : generic(g), specialized(s) {}
    ProcessFunctions() : generic(nullptr), specialized(nullptr) {}
  };
  typedef std::map<std::string, ProcessFunctions> ProcessMap;
  ProcessMap processMap_;
  void process_ping(int32_t seqid, ::apache::thrift::protocol::TProtocol *iprot,
                    ::apache::thrift::protocol::TProtocol *oprot,
                    void *callContext);
  void process_ping(int32_t seqid, Protocol_ *iprot, Protocol_ *oprot,
                    void *callContext);
  void process_insert(int32_t seqid,
                      ::apache::thrift::protocol::TProtocol *iprot,
                      ::apache::thrift::protocol::TProtocol *oprot,
                      void *callContext);
  void process_insert(int32_t seqid, Protocol_ *iprot, Protocol_ *oprot,
                      void *callContext);
  void process_insert_for_latency(int32_t seqid,
                                  ::apache::thrift::protocol::TProtocol *iprot,
                                  ::apache::thrift::protocol::TProtocol *oprot,
                                  void *callContext);
  void process_insert_for_latency(int32_t seqid, Protocol_ *iprot,
                                  Protocol_ *oprot, void *callContext);
  void process_check(int32_t seqid,
                     ::apache::thrift::protocol::TProtocol *iprot,
                     ::apache::thrift::protocol::TProtocol *oprot,
                     void *callContext);
  void process_check(int32_t seqid, Protocol_ *iprot, Protocol_ *oprot,
                     void *callContext);
  void process_range_search(int32_t seqid,
                            ::apache::thrift::protocol::TProtocol *iprot,
                            ::apache::thrift::protocol::TProtocol *oprot,
                            void *callContext);
  void process_range_search(int32_t seqid, Protocol_ *iprot, Protocol_ *oprot,
                            void *callContext);
  void process_primary_key_lookup(int32_t seqid,
                                  ::apache::thrift::protocol::TProtocol *iprot,
                                  ::apache::thrift::protocol::TProtocol *oprot,
                                  void *callContext);
  void process_primary_key_lookup(int32_t seqid, Protocol_ *iprot,
                                  Protocol_ *oprot, void *callContext);
  void process_get_size(int32_t seqid,
                        ::apache::thrift::protocol::TProtocol *iprot,
                        ::apache::thrift::protocol::TProtocol *oprot,
                        void *callContext);
  void process_get_size(int32_t seqid, Protocol_ *iprot, Protocol_ *oprot,
                        void *callContext);
...
template <class Protocol_>
class MDTrieShardProcessorFactoryT
...
public:
  ...
  MDTrieShardConcurrentClientT(
      std::shared_ptr<Protocol_> iprot, std::shared_ptr<Protocol_> oprot,
      std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync)
      : sync_(sync) {
    setProtocolT(iprot, oprot);
  }
