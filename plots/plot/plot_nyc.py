...
if __name__ == "__main__": 
    ...
    clickhouse_path = "../../results/macrobench/nyc_clickhouse_4T"
    trinity_path = "../../results/macrobench/nyc_trinity_4T"
    aerospike_path = "../../results/macrobench/nyc_aerospike_4T"
    timescale_path = "../../results/macrobench/nyc_timescale_4T"
    ...
    plot_miss_ratio_diff([trinity_latencies.values(), clickhouse_latencies.values(), aerospike_latencies.values(), timescale_latencies.values()], ["Trinity", "ClickHouse", "Aerospike", "TimescaleDB"], "nyc_search_macro")
    # plot_miss_ratio_diff([clickhouse_latencies.values(), trinity_latencies.values(), aerospike_latencies.values()], ["ClickHouse", "Trinity", "Aerospike"], "nyc_range_search_4T")
